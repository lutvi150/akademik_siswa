<head>
    ...
    <meta charset="utf-8">
    {{-- <meta http-equiv="X-UA-Compatiblwe" content="IE=edge"> --}}
    ...
    <!-- Bootstrap -->
    <link href="{{asset('assets/theme/1/bootstrap/dist/css/bootstrap.min.css')}}" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="{{asset('assets/theme/1/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet">
    <!-- NProgress -->
